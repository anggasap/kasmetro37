...
class Lapneracamodel extends CI_Model {
	...
	public function get_data_neraca_aktiva($induk=0)
	{
		$data = array();
	...
	public function get_data_neraca_pasiva($induk=0){
		$data = array();
	...
	public function get_labarugi_berjalan(){
		...
		$sql.= "(SELECT saldo_akhir FROM web_temp_perkiraan WHERE kode_perk=6)) as lbrg_berjalan";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	public function get_total_modal($tgl_trans){
