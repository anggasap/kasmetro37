                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-body">
                                ...
                                <thead>
                                    <tr>
                                        <th style="width:300px;" align="center">PENDAPATAN</th>
                                        <th style="width:200px;" align="center">RUPIAH</th>
                                    </tr>
                                </thead>
                                <?php
									foreach($multilevel_labarugi_aktiva as $data){
									...
									echo print_recursive_labarugi_aktiva($data['child']);
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-body">
                                ...
                                <thead>
                                    <tr>
                                        <th style="width:300px;" align="center">BIAYA</th>
                                        <th style="width:200px;" align="center">RUPIAH</th>
                                    </tr>
                                </thead>
                                <?php
									foreach($multilevel_labarugi_pasiva as $data){
										if($data['type']=='G'){
											$nama_perk="<strong>".$data['nama']."</strong>";
											if($data['saldo']<0){
									...
									echo '<tr><td>'.$nama_perk.'</td><td align="right">'.$saldo_perk.'</td></tr>' ;
									echo print_recursive_labarugi_pasiva($data['child']);
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-body">
                            	<table class="table">
                                	<tr>
                                        <td style="width:300px;"><strong>TOTAL PENDAPATAN</strong></td>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-body">
                            	<?php 
									...
									$lbrg_setelah_pajak = $lbrg_bjln-$pajak;
								?>
                                <table class="table">
                                	<tr>
                                        ...
                                        <?php
										$total_pasiva= $total_pasiva[0]->total_pasiva ;
										if($total_pasiva<0){
                                    ...
                                    <tr>
                                        <td style="width:300px;"><strong>LABA RUGI</strong></td>
                                        <td style="width:200px; text-align:right">
                                    ...
                                    <tr>
                                        <td style="width:300px;"><strong>PAJAK</strong></td>
                                        <td style="width:200px; text-align:right">
                                        
										<?php 
										
										if($pajak<0){
											$pajak="(".number_format(abs($pajak),2).")";
											echo $pajak;
										}else{
											$pajak=number_format($pajak,2);
											echo "<strong>".$pajak."</strong>";
										}
										?>
                                    ...
                                    <tr>
                                        <td style="width:300px;"><strong>LABA RUGI SETELAH PAJAK</strong></td>
                                        <td style="width:200px; text-align:right">
                                        
										<?php 
										
										if($lbrg_setelah_pajak<0){
											$lbrg_setelah_pajak="(".number_format(abs($lbrg_setelah_pajak),2).")";
											echo $lbrg_setelah_pajak;
										}else{
											$lbrg_setelah_pajak=number_format($lbrg_setelah_pajak,2);
											echo "<strong>".$lbrg_setelah_pajak."</strong>";
										}
										?>
