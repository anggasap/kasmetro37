            ...
            <div class="portlet-body form">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th width="10%" align="center">No Bukti</th>
                        <th width="30%" align="center">Uraian</th>
                        <th width="10%" align="center">Debet</th>
                        <th width="10%" align="center">Kredit</th>
                    ...
                    echo '<tr>';
                    echo '<td colspan="6" align="center"><strong>Saldo Awal</strong></td>';
                    ...
                    foreach($saldobukubesar->result() as $data){
                        ...
                        if($flagPerk == 1 || $flagPerk == 5){
                            $totSaldoAkhir  = $totSaldoAkhir + $data->debet - $data->kredit;
                        }else{
                            $totSaldoAkhir  = $totSaldoAkhir - $data->debet + $data->kredit;
                        }
                    ...
                    echo '<tr>';
                    echo '<td colspan="4"><strong>Total jumlah '.$namaPerk.'</strong></td>';
