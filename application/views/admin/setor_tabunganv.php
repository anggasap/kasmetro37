            ...
            <div class="portlet-body">
                ...
                <!-- START DIV CLASS ROW FOR SIZE 6 -->
                    	...
                    	<div class="form-body">
                    			...
                    			<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php echo form_input(array('name'=>'txtTGlTrans','id'=>'txtTGlTrans','class'=>'form-control input-medium','value'=>$this->session->userdata('tglD'),'readonly'=>'true'));?>
                                        </div>
                                    </div>
                             	</div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo form_input(array('name'=>'txtNama','id'=>'txtNama','class'=>'bersih form-control','required'=>'required','placeholder'=>'Nama nasabah','readonly'=>'true'));?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="txtJenisSimp" name="txtJenisSimp" type="text" placeholder="Jenis Simpanan" class="form-control bersih" readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo form_input(array('name'=>'txtSaldoBTrans','id'=>'txtSaldoBTrans','class'=>'form-control nomor','readonly'=>'true','style'=>'text-align:right'));?>
                                </div>
                            </div>
                        </div>    
                    </div>
                    	...
                    	<div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo form_input(array('name'=>'txtSaldoATrans','id'=>'txtSaldoATrans','class'=>'form-control nomor','readonly'=>'true','style'=>'text-align:right'));?>
                                </div>
                            </div>
                            <?php
							}elseif($judul == 'Penarikan Tabungan'){
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo form_input(array('name'=>'txtSaldoDptTarik','id'=>'txtSaldoDptTarik','class'=>'form-control nomor','readonly'=>'true','style'=>'text-align:right'));?>
                                </div>
                            </div>
                            <?php
							}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo form_input(array('name'=>'txtSaldoStlh','id'=>'txtSaldoStlh','class'=>'form-control nomor','readonly'=>'true','style'=>'text-align:right'));?>
                                </div>
                            </div>
                        	<div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="txtKuitansi" name="txtKuitansi" type="text" placeholder="No kuitansi" class="form-control bersih" required="" onkeyup="ToUpper(this);" readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <label>&nbsp;</label>
                                        <div class="input-group">
                                            <input id="txtJenisTrans" name="txtJenisTrans" type="text" style="width:96px;" required="" readonly="readonly" class="form-control"> 
                                        </div>                                   
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="txtJml" name="txtJml" type="text" class="form-control nomor" required="" onkeyup="" style="text-align:right;">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-actions">
                        <button type="submit" name="btnSimpan" class="btn blue" id="btnSimpan"><span class="glyphicon glyphicon-floppy-disk"></span> Simpan</button>               
