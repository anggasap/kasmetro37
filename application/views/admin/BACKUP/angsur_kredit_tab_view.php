...
<div id="main-content">
	...
	/*	
		...
		*/
		...
		foreach($kodetrans_tab_def_ob->result() as $row){
				 ...
				 //$dk_tab_tarik_ob= $row->TYPE_TRANS;
		}
	?>
	<legend >&nbsp;Angsuran Pinjaman OB Tabungan</legend>
	<?php
	...
	?>
    <?php 
		$attributes = array('id' => 'formangsur_ob_tab');
		echo form_open('angsur_kredit/setor_pinjaman_tab', $attributes);
		?>
      ...
      <div class="span12"><!-- span 12 -->
        ...
        <div class="row-fluid"><!-- row fluid kecil -->
          ...
          <h4>Info Rekening</h4>
					...
					<div class="row-fluid" >
						<div class="span2 teks-kanan" >No Rek Pinj</div>
                    ...
                    <div class="row-fluid">
						<div class="span2 teks-kanan">No Rek Tab</div>
						<div class="span4">
							<?php echo  form_input(array('name'=>'txtRekTabOb','class'=>'input-medium bersih','id'=>'txtRekTabOb','placeholder'=>'No rek tabungan','required'=>'required'));?>
						</div>
					</div>
                    <div class="row-fluid">
                    	<div class="span2 teks-kanan"></div>
						<div class="span4">
                        <?php echo  form_input(array('name'=>'txtNamaTabOb','class'=>'bersih','id'=>'txtNamaTabOb','placeholder'=>'Nama nasabah','readonly'=>'true','style'=>'width:290px;','required'=>'required'));?>
							
						</div>
                    </div>
                    <div class="row-fluid">
                    	<div class="span2 teks-kanan">Saldo Tabungan</div>
						<div class="span4">
                        <?php echo form_input(array('name'=>'txtSaldoTab','id'=>'txtSaldoTab','class'=>'input-medium nomor','readonly'=>'true','style'=>'text-align:right'));?>
							<?php // echo  form_input(array('type'=>'hidden','name'=>'txtNasIDTab','class'=>'bersih','id'=>'txtNasIDTab','required'=>'required'));?>
                    ...
                    <h4>Transaksi</h4>
					<div class="row-fluid">
						<div class="span2 teks-kanan" style="width:70px;">Trans Pinj</div>
						<div class="span5" >
							<?php
							$data = array();
							...
							//endforeach; 
							echo form_dropdown('DL_kodetrans_kre', $data,$kd_kre_def,'id="DL_kodetrans_kre"');
                    ...
                    <div class="row-fluid">
						<div class="span2 teks-kanan" style="width:70px;">Trans Tab</div>
						<div class="span5" >
							<?php
							$data = array();
							...
							endforeach;
							echo form_dropdown('DL_kodetrans_tab',$data,$kd_tab_def_ob,'id="DL_kodetrans_tab" class=""');
							?>
						</div>
						<div class="span2">
                            <?php echo form_input(array('name'=>'txtJenisTransTab','style'=>'width:20px;','id'=>'txtJenisTransTab','readonly'=>'true')); ?>
							<?php // echo form_input(array('name'=>'txtGlTab','id'=>'txtGlTab','readonly'=>'true','class'=>'bersih','style'=>'width:10px;')); ?>
						</div>
					</div>
					<div class="row-fluid">
		...
		<!--		<p style="line-height: .1em;">&nbsp;</p>-->
                ...
                <h4>Jumlah Setoran</h4>
					...
					<div class="row-fluid">
						...
						<div class="span2">
							<?php echo  form_input(array('name'=>'txtDiscBunga','class'=>'input-small nomor','id'=>'txtDiscBunga','style'=>'text-align:right','onkeyup'=>'AddAndRemoveSeparator(this);'));?>
						</div>
						<div class="span2 teks-kanan"  style="width:70px;">Disc</div>
						<div class="span2">
							<?php echo  form_input(array('name'=>'txtDiscDenda','class'=>'input-small nomor','id'=>'txtDiscDenda','style'=>'text-align:right','onkeyup'=>'AddAndRemoveSeparator(this);'));?>
						</div>
					</div>
					<div class="row-fluid">
						<div class="span2"  style="width:70px;">&nbsp;</div>
                     ...
                     <div class="row-fluid">
						...
						<div class="span2">
							<?php echo form_input(array('name'=>'txtJmlTabWajib','id'=>'txtJmlTabWajib','class'=>'input-small nomor byr','style'=>'text-align:right','readonly'=>'readonly','onkeyup'=>'AddAndRemoveSeparator(this);'));?>
						</div>
		...
		$(function() {
				$('#formangsur_ob_tab').submit(function (event) {
					  ...
					  if (jml_bayar==0){
						  ...
						  $.messager.alert('Perhatian','Saldo tabungan tidak mencukupi untuk transaksi ini.');
						  return false;
					  }else{
