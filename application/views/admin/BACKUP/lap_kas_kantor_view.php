...
<?php
$attributes = array('id' => 'id_form_lap_kas_kantor');
echo form_open('laporan_kas/lap_kas_kantor',$attributes);
?>

<legend >
&nbsp;Laporan Kas Kantor
<div  style="float:right;">
<button type="submit" class="btn btn-warning" id="btnCetak" name="btnCetak"><i class="icon-print"></i>&nbsp;Cetak</button>
&nbsp;&nbsp;&nbsp;
</div>
<div  style="float:right;">
</div>
