                	...
                	<div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-body">
                                ...
                                <input type="text" id="id_form_kons" /><!--menandai apakah komponen atau konstanta -->
                                <input type="text" id="id_konsperk" />
                                <input type="text" id="nm_konsperk" />
												 	...
												 	<div class="input-group">
                                                        ...
                                                        value="<?php echo $row->kode_perk;?>" class="form-control" />
                                                 			<span class="input-group-btn">
                                                                ...
                                                                data-target="#GL" data-toggle="modal" >
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <table class='table table-hover' id="tabel_perk">
                                  <thead >
                                    <tr>
                                       <th width='10%' style="display:none;" align='left'>Kd Perk</th>
                                  ...
                                  <tbody>
                                    <?php
                                     foreach($perkiraan->result() as $row){
                                        ?>
                                        <tr>
                                           <td style="display:none;"><?php echo ".".$row->kode_perk;?></td>
...
<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#tabel_konstanta tbody tr").click(function(){
				$('#id_form_kons').val(2);
				/*
				$(".listdata").removeClass('alert alert-info');
				$(this).addClass('alert alert-info');
				*/
				var id_kons_perk = $(this).find("td").eq(0).html();
				var nm_kons = $(this).find("td").eq(1).html();
				$("#id_konsperk").val(id_kons_perk);
				$("#nm_konsperk").val(nm_kons);
		...
		function cari_komponen(id_komponen){
			...
			$("#tabel_perk tbody tr").dblclick(function(){	
				var kdperk = $(this).find("td").eq(1).html();
				var tipe = $(this).find("td").eq(4).html();
			...
			function insert_komponen(kode_perk){
			  ...
			  var id_konsperk = $('#id_konsperk').val();
			  var nm_konsperk = $('#nm_konsperk').val();
			 //
			  //alert(bobot_resiko);
			  ...
			  }else{//if (id_form_kons==2){
				 
				  $.post("<?php echo site_url('/tks_bpr_c/insert_konstanta_perk'); ?>",{
					  'kd_perk':kode_perk,
					  'id_konsperk':id_konsperk,
					  'nm_konsperk':nm_konsperk
					  },
				  function(data){
					  //alert("angga");
				  },"json");
