		...
		<div class="form-group">
            ...
            <div class="input-group">
                ...
                <input id="umur" name="umur" placeholder="Umur Ekonomis"
                       class="form-control nomor2 input-small" readonly="true"> <span>Bulan</span>
            </div>
        </div>
		<div class="form-group">
			...
			<input id="kwitansi" name="kwitansi" placeholder="Nomor Kwitansi" class="form-control bersih input-medium" >
            </div>
        </div>
		<div class="form-group">
			...
			<input id="kode_trans" name="kode_trans" placeholder="Kode Transaksi" maxlength="3" class="form-control bersih input-small" >
            </div>
        </div>
	<!-- END FORM BODY-->
...
var TableManaged = function () {
    var initTable1 = function () {
        ...
        // begin first table
        table.dataTable({
            "ajax": "<?php echo base_url("/master_inventory/get_inv_realisasi"); ?>",
            "columns": [
                { "data": "noref" },
                { "data": "deskripsiref" },
                { "data": "nilaipengadaan" },
...
function confirm_reset() {
    ...
    if (r) {
		...
		function ajax_submit(){
			$.ajax({
				type:"POST",
				url:"<?php echo base_url(); ?>master_inventory/simpan_realisasi",
				data:dataString,
